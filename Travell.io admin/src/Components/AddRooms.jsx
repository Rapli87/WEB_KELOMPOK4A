...
const AddRooms = () => {
  ...
  const addRoomToFirebase = () => {
    if (
      ...
      return alert("Silahkan isi semua kolom.");
    }
  };
    ...
    <div className="container my-5">
      <div className="row">
        <div className="col-md-10 mx-auto col-12 card shadow-lg border-0 p-4">
          <div>
            <br></br>
            <h1 className="display-4 text-center">Tambah Destinasi</h1>
          </div>
                ...
                <form>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      required
                      id="price"
                      placeholder="Harga Destinasi"
                    />
                    <label htmlFor="size">Kapasitas</label>
                    <input
                      type="number"
                      className="form-control"
                      value={size}
                    ...
                    <label htmlFor="description">Penjelasan</label>
                    <textarea
                      className="form-control"
                      value={description}
                    ...
                    <label htmlFor="extras">Tambahan</label>
                    <textarea
                      className="form-control"
                      value={extras}
